      ...
      "      vec3 n =  vec3(mvMatrix * vec4(normal, 0.0));                                                      \n"  
      "      vec3 t =  vec3(mvMatrix * vec4(tangent, 0.0));                                                     \n"  
      ...
      "        vec3 vertexPosition   = normalize(vec3(mvMatrix * position));                                               \n"        
     ...
     //-----------------------------------------------------------------------------------------------------------------
      ...
      "         vec2 delta = vec2( EyeDir.x, EyeDir.y)* -1.0;                                                                                          \n"  
     
                                                                    
      "         vec3 height = (texture2D(HeightMap, varTexcoord.xy).r);                                                                       \n"  
        
      "         height = height * shininess + attenuation;                                                                                         \n"  
      
      "         newTexCoord = varTexcoord.xy + (height.x * delta);                                                                                  \n"  
