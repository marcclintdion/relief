...
GLfloat moveSet[] = {0.0, 0.0, 0.0, 0.0};
//-------------------------------------------------------------------------------------------------------------------- 
...
void ProcessKeyboard(void)
{
     ...
     //====================================================================================                                          
     #include "_MODEL_FOLDERS_/facing_UP/facing_UP_Keyboard.cpp"                                                               
     //====================================================================================                                          
...
*/    //-----------------------------------------------------------------------------    
   //==============================================================================
       ...
       if(keys[VK_F8])
       {
             ...
             outSettings << "var         facing_UP_POSITION[]    =  {"   << facing_UP_POSITION[0] << ", "
                                                                      << facing_UP_POSITION[1] << ", "
                                                                      << facing_UP_POSITION[2] << ", 1.0};\n\n";            
            
            
            
             outSettings << "var         facing_UP_ATTENUATION            =  " << facing_UP_ATTENUATION << ";\n";
             outSettings << "var         facing_UP_SHININESS              =  " << facing_UP_SHININESS << ";\n";             
             //outSettings << "var         facing_UP_NOISE_SCALE            =  " << facing_UP_NOISE_SCALE << ";\n\n";       
