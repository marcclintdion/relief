...
//========================================================================================================
    ...
    //"   vec3 tang =  tanA * vec3(normalFrag.x, normalFrag.z, normalFrag.y) + sinA * vec3(normalFrag.x, normalFrag.y, normalFrag.z) ;         \n" //!var         renderMonkeyish_C_LIGHT_POSITION_01[]    =  {0, 92.3999, 139.5, 1.0};var         renderMonkeyish_C_ATTENUATION    =  0.847001;var         renderMonkeyish_C_SHININESS    =  174.998;var         renderMonkeyish_C_NOISE_SCALE      =  -0.0105;


    "   vec3 tang =  tanA * vec3(normalFrag.z, normalFrag.y, normalFrag.x) + sinA * vec3(normalFrag.x, normalFrag.y, normalFrag.z) ;         \n"  //!var         renderMonkeyish_C_ATTENUATION    =  1.057;var         renderMonkeyish_C_SHININESS    =  205.001;var         renderMonkeyish_C_NOISE_SCALE      =  -0.0034;

    //"   vec3 tang =  sinA * vec3(normalFrag.x, normalFrag.x, normalFrag.x) ;                                                                \n" //!var         renderMonkeyish_C_ATTENUATION    =  0.847001;var         renderMonkeyish_C_SHININESS    =  174.998;var         renderMonkeyish_C_NOISE_SCALE      =  -0.0034;
