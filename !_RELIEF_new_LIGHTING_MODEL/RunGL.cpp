...
//######################################################################################################################
                              ...
                              //====================================================================================                                          
                              #include "_MODEL_FOLDERS_/relief_TristanDean/relief_TristanDean_Globals.cpp"                                                                
                              //====================================================================================                                          
...
{
     //====================================================================================                                          
     #include "_MODEL_FOLDERS_/relief_TristanDean/relief_TristanDean_Keyboard.cpp"                                                               
     //====================================================================================                                          
    ...
    if (keys['L'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_POSITION[0]         +=  0.1;                                                                            
    }                                                                                                                                   
    if (keys['J'])                                                                                                                   
    {                                                                                                                                   
             relief_TristanDean_POSITION[0]         -=  0.1;                                                                         
    ...
    if (keys['I'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_POSITION[1]         +=  0.1;                                                                            
    }	                                                                                                                                  
    if (keys['K'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_POSITION[1]         -=  0.1;                                                                            
    ...
    if (keys['O'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_POSITION[2]         +=  0.1;                                                                            
    }	                                                                                                                                  
    if (keys['U'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_POSITION[2]         -=  0.1;      
    ...
    if (keys['M'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_ATTENUATION                  +=  .001;                                                                            
    }	                                                                                                                                  
    if (keys['N'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_ATTENUATION                  -=  .001;                                                                            
    ...
    if (keys['X'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_SHININESS                    +=  1.001;                                                                            
    }	                                                                                                                                  
    if (keys['Z'])                                                                                                                      
    {	                                                                                                                                  
             relief_TristanDean_SHININESS                    -=  1.001;                                                                            
...
*/    //-----------------------------------------------------------------------------    
   //==============================================================================
       ...
       if(keys[VK_F8])
       {
             ...
             outSettings << "var         relief_TristanDean_POSITION[]    =  {"   << relief_TristanDean_POSITION[0] << ", "
                                                                      << relief_TristanDean_POSITION[1] << ", "
                                                                      << relief_TristanDean_POSITION[2] << ", 1.0};\n\n";            
...
void shutDownGL( void )
{
       ...
       //====================================================================================                                          
        #include "_MODEL_FOLDERS_/relief_TristanDean/relief_TristanDean_Shutdown.cpp"                                                               
        //====================================================================================                                          
